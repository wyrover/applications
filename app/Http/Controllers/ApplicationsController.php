...
class ApplicationsController extends Controller
{
    ...
    {
        $applications = Applications::where('company_id', Auth::user()->company_id)->where('app_only', '=', 1)->paginate(10);
...
//        $refs = References::where('applications_id', '=', $request->segment(4))->get();
    ...
    {
        $profile = Applications::where('reference_id', $request->segment(4))->orWhere('reference_two_id', $request->segment(4))->first();
