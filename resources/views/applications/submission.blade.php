        ...
        {!! Form::open(['url' => 'application', 'class' => 'form-horizontal']) !!}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group {{ $errors->has('signed_by') ? 'has-error' : '' }}">
                        <div class="col-sm-2">Digital Signature (full name) <span class="text-danger">*</span></div>
                        <div class="col-lg-5">
            ...
            <button class="btn btn-success btn-lg" type="submit">Submit Application</button><br /><br />
        {!! Form::close() !!}
    </div>
    </div>
</div>
