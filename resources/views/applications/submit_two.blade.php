...
<div class="container content">
    <div class="col-lg-12 col-md-6 col-sm-4 col-xs-4">
        {!! Form::open(['url' => 'application/'. $applicant->code .'/reference', 'class' => 'form-horizontal']) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" name="email_address" class="form-control" value="{!! $referee->referee_email !!}" autocomplete="off">
