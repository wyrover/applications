        ...
        <div class="col-md-12">
            <div class="form-login">
                ...
                <form method="POST" action="/password/reset">
                    ...
                    <br />
                    <input class="form-control input-sm chat-input" placeholder="Password" type="password" name="password" />
                    <input class="form-control input-sm chat-input" placeholder="Confirm Password" type="password" name="password_confirmation" />
